...
build:
	...
	@docker run --rm --privileged -v $(PWD):/workspace -v /build mcc-os-dev bash -c "sudo cp -a /workspace/* /build/ && cd /build && sudo lb config && sudo lb build && sudo cp *.iso /workspace/ || true"
